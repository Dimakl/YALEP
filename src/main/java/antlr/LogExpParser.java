...
public class LogExpParser extends Parser {
    ...
    public static class EvalContext extends ParserRuleContext {
        ...
        public TerminalNode BOOL() {
            return getToken(LogExpParser.BOOL, 0);
        }

        public TerminalNode EOF() {
            return getToken(LogExpParser.EOF, 0);
        }
    ...
    public static class IdentifierExpressionContext extends ExpressionContext {
        ...
        public TerminalNode IDENTIFIER() {
            return getToken(LogExpParser.IDENTIFIER, 0);
        }
    ...
    public static class NotExpressionContext extends ExpressionContext {
        ...
        public TerminalNode NOT() {
            return getToken(LogExpParser.NOT, 0);
        }
    ...
    public static class ParenExpressionContext extends ExpressionContext {
        ...
        public TerminalNode LPAREN() {
            return getToken(LogExpParser.LPAREN, 0);
        }
        ...
        public TerminalNode RPAREN() {
            return getToken(LogExpParser.RPAREN, 0);
        }
    ...
    public static class BinaryContext extends ParserRuleContext {
        ...
        public TerminalNode AND() {
            return getToken(LogExpParser.AND, 0);
        }

        public TerminalNode OR() {
            return getToken(LogExpParser.OR, 0);
        }
